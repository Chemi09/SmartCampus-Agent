(function () {
  ...
  function paymentStatus(p) {
    if (p === 'paid') return { cls: 'sc-badge-status-active', lbl: 'Payé' };
    if (p === 'pending') return { cls: 'sc-badge-status-suspended', lbl: 'En attente' };
  ...
  document.addEventListener('DOMContentLoaded', async function () {
    ...
    var avg =
      grades.length > 0
        ...
        : 'N/A';
    document.getElementById('ph-avg').textContent = avg === 'N/A' ? avg : avg + '/20';
    ...
    document.getElementById('ph-paid').textContent = '$' + paid;
      ...
      pt.innerHTML = pays
        .map(function (p) {
          ...
          return (
            ...
            SC_Utils.escapeHtml(paymentType(p.type)) +
